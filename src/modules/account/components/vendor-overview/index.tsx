...
const VendorOverview = ({ vendor, vendorAdmin }: { vendor: Vendor, vendorAdmin: VendorAdmin }) => {
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="px-4 py-2 bg-stone-900 text-white rounded-xl hover:bg-stone-800 transition-all font-medium flex items-center gap-2">
